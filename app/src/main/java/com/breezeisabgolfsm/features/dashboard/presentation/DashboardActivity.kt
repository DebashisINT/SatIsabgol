package com.breezeisabgolfsm.features.dashboard.presentation
...
import com.breezeisabgolfsm.*
import com.breezeisabgolfsm.R
import com.breezeisabgolfsm.app.*
import com.breezeisabgolfsm.app.NewFileUtils.browseDocuments
import com.breezeisabgolfsm.app.NewFileUtils.browsePDFDocuments
import com.breezeisabgolfsm.app.NewFileUtils.getExtension
import com.breezeisabgolfsm.app.domain.*
import com.breezeisabgolfsm.app.types.DashboardType
import com.breezeisabgolfsm.app.types.FragType
import com.breezeisabgolfsm.app.types.TopBarConfig
import com.breezeisabgolfsm.app.uiaction.DisplayAlert
import com.breezeisabgolfsm.app.utils.*
import com.breezeisabgolfsm.app.utils.AppUtils.Companion.isProfile
import com.breezeisabgolfsm.base.BaseResponse
import com.breezeisabgolfsm.base.presentation.BaseActivity
import com.breezeisabgolfsm.base.presentation.BaseFragment
import com.breezeisabgolfsm.features.NewQuotation.*
import com.breezeisabgolfsm.features.NewQuotation.api.GetQuotRegProvider
import com.breezeisabgolfsm.features.NewQuotation.model.ViewDetailsQuotResponse
import com.breezeisabgolfsm.features.SearchLocation.SearchLocationFragment
import com.breezeisabgolfsm.features.SearchLocation.locationInfoModel
import com.breezeisabgolfsm.features.TA.ViewAllTAListFragment
import com.breezeisabgolfsm.features.achievement.AchievementFragment
import com.breezeisabgolfsm.features.activities.presentation.*
import com.breezeisabgolfsm.features.addAttendence.*
import com.breezeisabgolfsm.features.addAttendence.api.addattendenceapi.AddAttendenceRepoProvider
import com.breezeisabgolfsm.features.addAttendence.api.leavetytpeapi.LeaveTypeRepoProvider
import com.breezeisabgolfsm.features.addAttendence.model.GetReportToFCMResponse
import com.breezeisabgolfsm.features.addAttendence.model.GetReportToResponse
import com.breezeisabgolfsm.features.addAttendence.model.Leave_list_Response
import com.breezeisabgolfsm.features.addorder.presentation.AddOrderFragment
...
import com.breezeisabgolfsm.features.addshop.presentation.AddShopFragment
import com.breezeisabgolfsm.features.addshop.presentation.OTPVerificationDialog
import com.breezeisabgolfsm.features.addshop.presentation.ScanImageFragment
import com.breezeisabgolfsm.features.addshop.presentation.ShowCardDetailsDialog
import com.breezeisabgolfsm.features.alarm.model.AlarmData
import com.breezeisabgolfsm.features.alarm.presetation.AttendanceReportFragment
import com.breezeisabgolfsm.features.alarm.presetation.PerformanceReportFragment
import com.breezeisabgolfsm.features.alarm.presetation.VisitReportDetailsFragment
import com.breezeisabgolfsm.features.alarm.presetation.VisitReportFragment
import com.breezeisabgolfsm.features.attendance.AttendanceFragment
import com.breezeisabgolfsm.features.attendance.api.AttendanceRepositoryProvider
import com.breezeisabgolfsm.features.attendance.model.AttendanceRequest
import com.breezeisabgolfsm.features.attendance.model.AttendanceResponse
import com.breezeisabgolfsm.features.averageshop.presentation.AverageShopFragment
import com.breezeisabgolfsm.features.avgorder.presentation.AverageOrderFragment
import com.breezeisabgolfsm.features.avgtimespent.presentation.AvgTimespentShopListFragment
import com.breezeisabgolfsm.features.beatCustom.TeamBeatListFragment
import com.breezeisabgolfsm.features.billing.presentation.AddBillingFragment
import com.breezeisabgolfsm.features.billing.presentation.BillingDetailsFragment
import com.breezeisabgolfsm.features.billing.presentation.BillingListFragment
import com.breezeisabgolfsm.features.changepassword.presentation.ChangePasswordDialog
import com.breezeisabgolfsm.features.chat.model.ChatListDataModel
import com.breezeisabgolfsm.features.chat.model.ChatUserDataModel
import com.breezeisabgolfsm.features.chat.model.GroupUserDataModel
import com.breezeisabgolfsm.features.chat.presentation.*
import com.breezeisabgolfsm.features.chatbot.presentation.ChatBotFragment
import com.breezeisabgolfsm.features.chatbot.presentation.ChatBotShopListFragment
import com.breezeisabgolfsm.features.chatbot.presentation.ReportsFragment
import com.breezeisabgolfsm.features.chatbot.presentation.SelectLanguageDialog
import com.breezeisabgolfsm.features.commondialog.presentation.CommonDialog
import com.breezeisabgolfsm.features.commondialog.presentation.CommonDialogClickListener
import com.breezeisabgolfsm.features.commondialogsinglebtn.AddFeedbackSingleBtnDialog
import com.breezeisabgolfsm.features.commondialogsinglebtn.CommonDialogSingleBtn
import com.breezeisabgolfsm.features.commondialogsinglebtn.OnDialogClickListener
import com.breezeisabgolfsm.features.commondialogsinglebtn.TermsAndConditionsSingleBtnDialog
import com.breezeisabgolfsm.features.contacts.ContactDtls
import com.breezeisabgolfsm.features.contacts.ContactGr
import com.breezeisabgolfsm.features.contacts.ContactsAddFrag
import com.breezeisabgolfsm.features.contacts.ContactsFrag
import com.breezeisabgolfsm.features.contacts.SchedulerViewFrag
import com.breezeisabgolfsm.features.contacts.SchedulerAddFormFrag
import com.breezeisabgolfsm.features.contacts.TemplateAddFrag
import com.breezeisabgolfsm.features.contacts.TemplateViewFrag
import com.breezeisabgolfsm.features.dailyPlan.prsentation.AllShopListFragment
import com.breezeisabgolfsm.features.dailyPlan.prsentation.DailyPlanListFragment
import com.breezeisabgolfsm.features.dailyPlan.prsentation.PlanDetailsFragment
import com.breezeisabgolfsm.features.damageProduct.ShopDamageProductListFrag
import com.breezeisabgolfsm.features.damageProduct.ShopDamageProductSubmitFrag
import com.breezeisabgolfsm.features.dashboard.presentation.api.ShopVisitImageUploadRepoProvider
import com.breezeisabgolfsm.features.dashboard.presentation.api.dashboardApi.DashboardRepoProvider
import com.breezeisabgolfsm.features.dashboard.presentation.api.otpsentapi.OtpSentRepoProvider
import com.breezeisabgolfsm.features.dashboard.presentation.api.otpverifyapi.OtpVerificationRepoProvider
import com.breezeisabgolfsm.features.dashboard.presentation.api.unreadnotificationapi.UnreadNotificationRepoProvider
import com.breezeisabgolfsm.features.dashboard.presentation.getcontentlisapi.GetContentListRepoProvider
import com.breezeisabgolfsm.features.dashboard.presentation.model.ContentListResponseModel
import com.breezeisabgolfsm.features.dashboard.presentation.model.ShopVisitImageUploadInputModel
import com.breezeisabgolfsm.features.dashboard.presentation.model.UnreadNotificationResponseModel
import com.breezeisabgolfsm.features.device_info.presentation.DeviceInfoListFragment
import com.breezeisabgolfsm.features.distributorwiseorder.DistributorwiseorderlistFragment
import com.breezeisabgolfsm.features.document.DocumentRepoFeatureNewFragment
import com.breezeisabgolfsm.features.document.presentation.DocumentListFragment
import com.breezeisabgolfsm.features.document.presentation.DocumentTypeListFragment
import com.breezeisabgolfsm.features.document.presentation.OpenFileWebViewFragment
import com.breezeisabgolfsm.features.dymanicSection.presentation.AddDynamicFragment
import com.breezeisabgolfsm.features.dymanicSection.presentation.AllDynamicListFragment
import com.breezeisabgolfsm.features.dymanicSection.presentation.DynamicListFragment
import com.breezeisabgolfsm.features.dymanicSection.presentation.EditDynamicFragment
import com.breezeisabgolfsm.features.gpsDisabilityScreen.GpsDisableFragment
import com.breezeisabgolfsm.features.home.presentation.HomeFragment
import com.breezeisabgolfsm.features.homelocation.presentation.HomeLocationFragment
import com.breezeisabgolfsm.features.homelocation.presentation.HomeLocationMapFragment
import com.breezeisabgolfsm.features.know_your_state.KnowYourStateFragment
import com.breezeisabgolfsm.features.lead.LeadFrag
import com.breezeisabgolfsm.features.lead.ViewLeadFrag
import com.breezeisabgolfsm.features.leaveapplynew.LeaveHome
import com.breezeisabgolfsm.features.leaveapplynew.model.clearAttendanceonRejectReqModelRejectReqModel
import com.breezeisabgolfsm.features.localshops.LocalShopListFragment
import com.breezeisabgolfsm.features.localshops.LocalShopListMapFragment
import com.breezeisabgolfsm.features.localshops.NearByShopsMapFragment
import com.breezeisabgolfsm.features.location.*
import com.breezeisabgolfsm.features.location.api.LocationRepoProvider
import com.breezeisabgolfsm.features.location.model.*
import com.breezeisabgolfsm.features.location.shopRevisitStatus.ShopRevisitStatusRepositoryProvider
import com.breezeisabgolfsm.features.location.shopdurationapi.ShopDurationRepositoryProvider
import com.breezeisabgolfsm.features.login.ShopFeedbackEntity
import com.breezeisabgolfsm.features.login.model.alarmconfigmodel.AlarmConfigDataModel
import com.breezeisabgolfsm.features.login.presentation.LoginActivity
import com.breezeisabgolfsm.features.logout.presentation.api.LogoutRepositoryProvider
import com.breezeisabgolfsm.features.logoutsync.presentation.LogoutSyncFragment
import com.breezeisabgolfsm.features.marketAssist.MarketAssistTabFrag
import com.breezeisabgolfsm.features.marketAssist.ShopDtlsMarketAssistFrag
import com.breezeisabgolfsm.features.marketAssist.ShopListMarketAssistFrag
import com.breezeisabgolfsm.features.marketing.presentation.MarketingPagerFragment
import com.breezeisabgolfsm.features.meetinglist.prsentation.MeetingListFragment
import com.breezeisabgolfsm.features.member.MapViewForTeamFrag
import com.breezeisabgolfsm.features.member.model.TeamLocDataModel
import com.breezeisabgolfsm.features.member.model.TeamShopListDataModel
import com.breezeisabgolfsm.features.member.presentation.*
import com.breezeisabgolfsm.features.menuBeat.MenuBeatFrag
import com.breezeisabgolfsm.features.micro_learning.presentation.FileOpeningTimeIntentService
import com.breezeisabgolfsm.features.micro_learning.presentation.MicroLearningListFragment
import com.breezeisabgolfsm.features.micro_learning.presentation.MicroLearningWebViewFragment
import com.breezeisabgolfsm.features.myallowancerequest.MyallowanceRequestFragment
import com.breezeisabgolfsm.features.myjobs.model.CustomerDataModel
import com.breezeisabgolfsm.features.myjobs.presentation.*
import com.breezeisabgolfsm.features.myorder.presentation.MyOrderListFragment
import com.breezeisabgolfsm.features.myprofile.presentation.MyProfileFragment
import com.breezeisabgolfsm.features.nearbyshops.api.ShopListRepositoryProvider
import com.breezeisabgolfsm.features.nearbyshops.model.ShopData
import com.breezeisabgolfsm.features.nearbyshops.model.ShopListResponse
import com.breezeisabgolfsm.features.nearbyshops.multipleattachImage.MultipleImageFragment
import com.breezeisabgolfsm.features.nearbyshops.presentation.BeatListFragment
import com.breezeisabgolfsm.features.nearbyshops.presentation.NearByShopsListFragment
import com.breezeisabgolfsm.features.nearbyshops.presentation.NewNearByShopsListFragment
import com.breezeisabgolfsm.features.nearbyshops.presentation.ShopCallHisFrag
import com.breezeisabgolfsm.features.nearbyuserlist.presentation.NearbyUserListFragment
import com.breezeisabgolfsm.features.newcollection.CollectionDetailsStatusFragment
import com.breezeisabgolfsm.features.newcollection.CollectionShopListFragment
import com.breezeisabgolfsm.features.newcollection.NewCollectionListFragment
import com.breezeisabgolfsm.features.newcollectionreport.*
import com.breezeisabgolfsm.features.notification.NotificationFragment
import com.breezeisabgolfsm.features.orderList.NewDateWiseOrderListFragment
import com.breezeisabgolfsm.features.orderList.NewOrderListFragment
import com.breezeisabgolfsm.features.orderList.OrderListFragment
import com.breezeisabgolfsm.features.orderdetail.presentation.OrderDetailFragment
import com.breezeisabgolfsm.features.orderhistory.ActivityMapFragment
import com.breezeisabgolfsm.features.orderhistory.OrderhistoryFragment
import com.breezeisabgolfsm.features.orderhistory.TimeLineFragment
import com.breezeisabgolfsm.features.orderhistory.activitiesapi.LocationFetchRepositoryProvider
...
import com.breezeisabgolfsm.features.orderhistory.model.LocationData
import com.breezeisabgolfsm.features.pendinglocationinout.PendingOutLocationFrag
import com.breezeisabgolfsm.features.performance.GpsStatusFragment
import com.breezeisabgolfsm.features.performance.PerformanceFragment
import com.breezeisabgolfsm.features.performance.api.UpdateGpsStatusRepoProvider
import com.breezeisabgolfsm.features.performance.model.UpdateGpsInputParamsModel
import com.breezeisabgolfsm.features.performanceAPP.OwnPerformanceFragment
import com.breezeisabgolfsm.features.performanceAPP.PerformanceAppFragment
import com.breezeisabgolfsm.features.performanceAPP.allPerformanceFrag
import com.breezeisabgolfsm.features.permissionList.ViewPermissionFragment
import com.breezeisabgolfsm.features.photoReg.*
import com.breezeisabgolfsm.features.privacypolicy.PrivacypolicyWebviewFrag
import com.breezeisabgolfsm.features.quotation.presentation.*
import com.breezeisabgolfsm.features.reimbursement.presentation.*
import com.breezeisabgolfsm.features.report.presentation.*
import com.breezeisabgolfsm.features.returnsOrder.*
import com.breezeisabgolfsm.features.settings.presentation.SettingsFragment
import com.breezeisabgolfsm.features.shopFeedbackHistory.ShopFeedbackHisFrag
import com.breezeisabgolfsm.features.shopdetail.presentation.*
import com.breezeisabgolfsm.features.shopdetail.presentation.api.EditShopRepoProvider
import com.breezeisabgolfsm.features.stock.StockDetailsFragment
import com.breezeisabgolfsm.features.stock.StockListFragment
import com.breezeisabgolfsm.features.stockAddCurrentStock.AddShopStockFragment
import com.breezeisabgolfsm.features.stockAddCurrentStock.UpdateShopStockFragment
import com.breezeisabgolfsm.features.stockAddCurrentStock.ViewStockDetailsFragment
import com.breezeisabgolfsm.features.stockAddCurrentStock.model.MultipleImageFileUploadonStock
import com.breezeisabgolfsm.features.stockCompetetorStock.AddCompetetorStockFragment
import com.breezeisabgolfsm.features.stockCompetetorStock.CompetetorStockFragment
import com.breezeisabgolfsm.features.stockCompetetorStock.ViewComStockProductDetails
import com.breezeisabgolfsm.features.survey.SurveyFrag
import com.breezeisabgolfsm.features.survey.SurveyViewDtlsFrag
import com.breezeisabgolfsm.features.survey.SurveyViewFrag
import com.breezeisabgolfsm.features.task.presentation.AddTaskFragment
import com.breezeisabgolfsm.features.task.presentation.CalenderTaskFragment
import com.breezeisabgolfsm.features.task.presentation.EditTaskFragment
import com.breezeisabgolfsm.features.task.presentation.TaskListFragment
import com.breezeisabgolfsm.features.taskManagement.TaskManagementFrag
import com.breezeisabgolfsm.features.taskManagement.ViewTaskManagementFrag
import com.breezeisabgolfsm.features.timesheet.presentation.AddTimeSheetFragment
import com.breezeisabgolfsm.features.timesheet.presentation.EditTimeSheetFragment
import com.breezeisabgolfsm.features.timesheet.presentation.TimeSheetListFragment
import com.breezeisabgolfsm.features.viewAllOrder.CartFragment
import com.breezeisabgolfsm.features.viewAllOrder.OrderTypeListFragment
import com.breezeisabgolfsm.features.viewAllOrder.ViewAllOrderListFragment
import com.breezeisabgolfsm.features.viewAllOrder.ViewCartFragment
import com.breezeisabgolfsm.features.viewAllOrder.orderNew.NewOdrScrListFragment
import com.breezeisabgolfsm.features.viewAllOrder.orderNew.NewOrderScrActiFragment
import com.breezeisabgolfsm.features.viewAllOrder.orderNew.NewOrderScrOrderDetailsFragment
import com.breezeisabgolfsm.features.viewAllOrder.orderNew.NeworderScrCartFragment
import com.breezeisabgolfsm.features.viewAllOrder.orderOptimized.OrderProductCartFrag
import com.breezeisabgolfsm.features.viewAllOrder.orderOptimized.OrderProductListFrag
import com.breezeisabgolfsm.features.viewPPDDStock.ViewOutstandingFragment
import com.breezeisabgolfsm.features.viewPPDDStock.ViewPPDDListFragment
import com.breezeisabgolfsm.features.viewPPDDStock.ViewPPDDListOutstandingFragment
import com.breezeisabgolfsm.features.viewPPDDStock.ViewStockFragment
import com.breezeisabgolfsm.features.weather.presentation.WeatherFragment
import com.breezeisabgolfsm.mappackage.MapActivity
import com.breezeisabgolfsm.mappackage.MapActivityWithoutPath
import com.breezeisabgolfsm.mappackage.SendBrod
...
//        val phototUri = Uri.parse(localAbsoluteFilePath)
            //val fileUrl = Uri.parse(File(Environment.getExternalStorageDirectory(), "xbreezeisabgolfsmlogsample/log").path);
            //27-09-2021
//            val fileUrl = Uri.parse(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbreezeisabgolfsmlogsample/log").path);
...
//                BuildConfig.APPLICATION_ID+"/Log/Fsmlog.html").path);
            var currentDBPath="/data/user/0/com.breezeisabgolfsm/files/Fsmlog.html"
...
//        startActivity(Intent.createChooser(emailIntent,""))
    ...
    fun openShare(){
        try{
            ...
            val fileUrl1 = Uri.parse(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbreezeisabgolfsmlogsample/log").path);
            val fileUrl2 = Uri.parse(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbreezeisabgolfsmlogsample/log.bak.1").path);
...
//        return super.onCreateOptionsMenu(menu)
    ...
    fun generateNoteOnSD(context: Context?, sFileName: String?, sBody: String?) {
        try {
            val root =  File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbreezeisabgolfsmlogsample/log" + ".txt")
            if (!root.exists()) {
                root.mkdirs()
            }
...
//        }
        val bytes = ByteArrayOutputStream()
//        bm!!.compress(Bitmap.CompressFormat.JPEG, 90, bytes)
        var destination = File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbreezeisabgolfsmlogsample/log")
        val fo: FileOutputStream
        val fo1:FileWriter
        try {
            fo = FileOutputStream(destination)
