package com.breezeisabgolfsm.features.logoutsync.presentation
...
import com.breezeisabgolfsm.app.AppDatabase
...
import com.breezeisabgolfsm.app.utils.Toaster
import com.breezeisabgolfsm.base.BaseResponse
import com.breezeisabgolfsm.base.presentation.BaseActivity
import com.breezeisabgolfsm.base.presentation.BaseActivity.Companion.compositeDisposable
...
import com.breezeisabgolfsm.features.billing.api.AddBillingRepoProvider
import com.breezeisabgolfsm.features.billing.model.AddBillingInputParamsModel
...
import com.breezeisabgolfsm.features.dashboard.presentation.ReasonDialog
...
import com.breezeisabgolfsm.features.document.model.AddEditDocumentInputParams
import com.breezeisabgolfsm.features.document.model.DocumentAttachmentModel
...
import com.breezeisabgolfsm.features.nearbyshops.api.updateaddress.ShopAddressUpdateRepoProvider
...
import com.breezeisabgolfsm.features.orderhistory.api.LocationUpdateRepositoryProviders
import com.breezeisabgolfsm.features.orderhistory.model.*
...
import com.breezeisabgolfsm.features.quotation.model.AddQuotInputModel
import com.breezeisabgolfsm.features.shopdetail.presentation.api.EditShopRepoProvider
import com.breezeisabgolfsm.features.shopdetail.presentation.api.addcollection.AddCollectionRepoProvider
...
import com.breezeisabgolfsm.features.stockAddCurrentStock.ShopAddCurrentStockList
...
import com.breezeisabgolfsm.features.stockCompetetorStock.ShopAddCompetetorStockProductList
...
import com.breezeisabgolfsm.features.timesheet.model.AddTimeSheetInputModel
import com.breezeisabgolfsm.features.viewAllOrder.api.addorder.AddOrderRepoProvider
import com.breezeisabgolfsm.features.viewAllOrder.model.AddOrderInputParamsModel
import com.breezeisabgolfsm.features.viewAllOrder.model.AddOrderInputProductList
import com.breezeisabgolfsm.mappackage.SendBrod
import com.breezeisabgolfsm.widgets.AppCustomTextView
import com.breezeisabgolfsm.MonitorService
import com.breezeisabgolfsm.MySingleton
...
import com.breezeisabgolfsm.features.addshop.presentation.ShopExtraContactReq
...
import com.breezeisabgolfsm.features.login.model.GetConcurrentUserResponse
import com.breezeisabgolfsm.features.login.model.WhatsappApiData
import com.breezeisabgolfsm.features.performance.model.Gps_status_list
import com.breezeisabgolfsm.features.performance.model.UpdateGpsInputListParamsModel
import com.breezeisabgolfsm.features.returnsOrder.ReturnProductList
import com.breezeisabgolfsm.features.returnsOrder.ReturnRequest
import com.breezeisabgolfsm.features.viewAllOrder.model.NewOrderSaveApiModel
...
//            checkToCallActivity()
    ...
    private fun callLogshareApi(){
        ...
        if(Pref.LogoutWithLogFile){
            try{
                val filesForZip: Array<String> = arrayOf(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbreezeisabgolfsmlogsample/log").path)
                ZipOutputStream(BufferedOutputStream(FileOutputStream(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbreezeisabgolfsmlogsample/log.zip").path))).use { out ->
                ...
                val fileUrl = Uri.parse(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbreezeisabgolfsmlogsample/log.zip").path);
